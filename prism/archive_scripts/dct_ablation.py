...
from prism.spectral_init import (
...
def run_training(name, spectra_coeffs, seed=42, steps=1000, lr=6.25e-5):
    ...
    from prism.config import TrainConfig, get_device, set_process_memory_limit
...
def main():
    ...
    for n_dct in n_dct_values:
        result_path = f"prism/results/dct_ablation_n{n_dct}.json"
