...
from prism.config import TrainConfig, get_device, install_signal_handlers
...
spectra = json.load(open("prism/results/extracted_spectra.json"))
...
# Save
path = "prism/results/diag_extracted_s137_spikeskip.json"
...
# Compare
print(f"\n=== COMPARISON ===")
orig = json.load(open("prism/results/diag_extracted_s137.json"))
