...
Usage:
    python -m prism.compare              # Quick 200-step comparison
    python -m prism.compare --steps 1000 # Custom step count
"""
import sys
import os
import json
...
def run_comparison(max_steps=200, output_dir="prism/results"):
    ...
    # Generate plots
    try:
        from prism.plot import plot_loss_curves, plot_perplexity_checkpoints
