...
from prism.baselines import make_init_fn, BASELINE_METHODS
from prism.spectral_init import decode_search_vector


def run_baselines(config: TrainConfig = None, output_dir: str = "prism/results",
                  verbose: bool = True):
...
def run_imt_shaped(genome_path: str, config: TrainConfig = None,
                   output_dir: str = "prism/results", verbose: bool = True):
