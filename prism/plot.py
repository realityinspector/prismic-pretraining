...
from prism.spectral_init import dct_expand


def plot_loss_curves(results: dict, output_dir: str = "prism/results"):
...
def plot_perplexity_checkpoints(results: dict, output_dir: str = "prism/results"):
...
def plot_spectra(spectra_coeffs: dict, output_dir: str = "prism/results"):
...
def plot_search_history(history_path: str, output_dir: str = "prism/results"):
...
def plot_all_from_dir(output_dir: str = "prism/results"):
